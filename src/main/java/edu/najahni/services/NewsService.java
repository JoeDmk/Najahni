...
public class NewsService {
    ...
    // ⚠️ NewsAPI gratuit ne fonctionne QUE depuis localhost (pas depuis un serveur déployé)
    // Remplacez par votre clé sur https://newsapi.org/register
    private static final String API_KEY  = "fcb19f8db425428d8e8a61d0b64f4954";
