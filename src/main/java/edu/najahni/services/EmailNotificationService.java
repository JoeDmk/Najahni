...
public class EmailNotificationService {
    ...
    // ===== CONFIGURATION GMAIL =====
    // 1. Va sur myaccount.google.com → Sécurité → Mots de passe des applications
    // 2. Crée un mot de passe pour "Mail" → tu obtiens un code 16 caractères
    // 3. Colle-le ici (pas ton vrai mot de passe Gmail !)
    private static final String EMAIL_EXPEDITEUR = "mahdibenmariem1@gmail.com";        // ← Ton Gmail
    private static final String MOT_DE_PASSE_APP = "qodc kdxf czbm rjdn";     // ← Mot de passe d'application
