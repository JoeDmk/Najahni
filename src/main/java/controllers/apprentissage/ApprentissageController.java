 ...
 */
 ...
 System.err.println("\u26A0 Erreur lors du chargement des données apprentissage: " + e.getMessage());
 e.printStackTrace();
 }
 ...
 */
 ...
 new javafx.beans.property.SimpleObjectProperty<>((Integer) cellData.getValue()[3]));
 ...
 */
 ...
 String iconChar = (badge.getNom() != null && !badge.getNom().isBlank())
 ? badge.getNom().substring(0, 1).toUpperCase() : "B";
 Label iconLabel = new Label(iconChar);
 iconLabel.setStyle("-fx-font-size: 32px; -fx-font-weight: bold;" + (obtained ? "" : " -fx-opacity: 0.5;"));

 Label nameLabel = new Label(badge.getNom());
 nameLabel.setStyle("-fx-font-size: 11px; -fx-text-fill: #333; -fx-font-weight: bold;");
 nameLabel.setWrapText(true);

 Label descLabel = new Label(obtained ? "Obtenu" : "Verrouille");
 ...
 */
 ...
 "Complete le: " + progression.getDateObtentionFormatee() : 
 "En cours..."
 );
 ...
 */
 ...
 tools.NavigationHelper.goHome(lblTotalXP);
 }
}
