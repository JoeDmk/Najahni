...
public class MentorshipRequestListController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        btnEdit.setOnAction(e -> {
            if (selectedRequest != null) {
                if (selectedRequest.getEntrepreneurId() != currentUserId && selectedRequest.getMentorId() != currentUserId) {
                    showAlert("Vous ne pouvez modifier que vos propres demandes");
                    return;
                }
        ...
        btnDelete.setOnAction(e -> {
            if (selectedRequest != null) {
                if (selectedRequest.getEntrepreneurId() != currentUserId && selectedRequest.getMentorId() != currentUserId) {
                    showAlert("Vous ne pouvez supprimer que vos propres demandes");
                    return;
                }
    ...
    private void loadData() {
        ObservableList<MentorshipRequest> all = FXCollections.observableArrayList(service.getAll());
        masterList = FXCollections.observableArrayList();
        for (MentorshipRequest r : all) {
    ...
    private VBox createCard(MentorshipRequest request) {
        ...
        // Project
        Label projectLabel = new Label("ðŸ“ " + (request.getProjectName() != null ? request.getProjectName() : "Project #" + request.getProjectId()));
        ...
        Label dateLabel = new Label("ðŸ“… " + (request.getDate() != null ? request.getDate().toString() : "N/A"));
        dateLabel.setFont(Font.font("Segoe UI", 12));
        dateLabel.setTextFill(Color.web("#6b7280"));

        Label timeLabel = new Label("ðŸ• " + (request.getTime() != null ? request.getTime() : "N/A"));
    ...
    private void navigateToForm(MentorshipRequest request) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/mentorat/MentorshipRequestForm.fxml"));
    ...
    private void goToHome() {
        tools.NavigationHelper.goHome(cardsContainer);
    }
