...
public class FrontOfficeController {
    ...
    public void initialize() {
        ...
        boolean isEntrepreneur = currentUser != null && currentUser.getRole() == Type.ENTREPRENEUR;
    ...
    public boolean isEntrepreneur() {
        User u = SessionService.getInstance().getCurrentUser();
        return u != null && u.getRole() == Type.ENTREPRENEUR;
    }
    ...
    public void showOpportunities() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontOpportunitiesView.fxml");
    ...
    public void showOffers() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontOffersView.fxml");
    ...
    public void showRiskAnalysis() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontRiskAnalysisView.fxml");
    ...
    public void showPortfolio() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontPortfolioView.fxml");
        setActiveNavLink(btnFoPortfolio);
    }

    /**
     * Shows the front-office Contracts view.
     */
    @FXML
    public void showContracts() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontContractsView.fxml");
        setActiveNavLink(btnContracts);
    }

    /**
     * Shows the front-office AI Matching view.
     */
    @FXML
    public void showAIMatching() {
        closeInboxIfOpen();
        loadView("/views/investissement/FrontAIMatchingView.fxml");
        setActiveNavLink(btnAIMatching);
    }
    ...
    public void showOffers(int opportunityId) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/investissement/FrontOffersView.fxml"));
    ...
    public void handleLogout() {
        if (AlertUtils.showConfirmation("Déconnexion", "Êtes-vous sûr de vouloir vous déconnecter ?")) {
            SessionService.getInstance().setCurrentUser(null);
            try {
