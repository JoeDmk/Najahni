...
import models.investissement.EconomicData;
import models.investissement.InvestmentOpportunity;
import services.investissement.EconomicApiService;
import services.investissement.EconomicRiskEngine;
...
public class FrontRiskAnalysisController {
    ...
    private void addAIDeepAnalysisButton(int score, BigDecimal amount, LocalDate deadline) {
        ...
        btnAI.setOnAction(e -> {
            ...
            geminiService.analyzeRisk("Investissement personnalisé", country,
                    ...
                    "Montant: " + CurrencyService.format(amount.doubleValue(), getUserCurrency()) + ", Contexte: " + country, score)
    ...
    private HBox createOpportunityCard(InvestmentOpportunity opp) {
        ...
        Label amountLabel = new Label(opp.getFormattedAmount(getUserCurrency(), new CurrencyService()));
