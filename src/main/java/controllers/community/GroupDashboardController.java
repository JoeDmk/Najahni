    ...
    import services.community.GroupJoinRequestCRUD;
    import models.community.GroupJoinRequest;

    import models.community.Group;
    import models.community.GroupMember;
    import services.community.GroupCRUD;
    import services.community.GroupMemberCRUD;
    ...
    public class GroupDashboardController {
        ...
        private void openEditThread(Thread thread) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/community/EditThread.fxml"));
        ...
        private void openThreadPage(Thread thread) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/community/ThreadPage.fxml"));
                Parent root = loader.load();
        ...
        private void addThread() {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/community/AddThread.fxml"));
                Parent root = loader.load();
        ...
        private void handleGoHome() {
            tools.NavigationHelper.goHome(groupName);
        }
