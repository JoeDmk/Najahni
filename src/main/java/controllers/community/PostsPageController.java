    ...
    import services.community.PostCRUD;
    import services.community.PostReactionCRUD;
    ...
    public class PostsPageController {
        ...
        private void showImageZoomDialog(String imageUrl) {
            ...
            try {
                pane.getStylesheets().add(getClass().getResource("/views/community/styles/app.css").toExternalForm());
            } catch (Exception ignored) {}
...
// common French apostrophes
        ...
        private void handleGoHome() {
            tools.NavigationHelper.goHome(postsContainer);
        }
    }
