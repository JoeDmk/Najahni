 ...
 *
 * <h3>Configuration :</h3>
 * Clé secrète de test Stripe lue depuis secrets.properties (stripe.secret_key).
 *
...
public class PaymentService {
    ...
    static {
        String key = "";
        try (InputStream is = PaymentService.class.getClassLoader().getResourceAsStream("secrets.properties")) {
            if (is != null) {
            ...
            LOG.warning("Could not load stripe.secret_key from secrets.properties: " + e.getMessage());
        }
        TEST_SECRET_KEY = key;
    }
