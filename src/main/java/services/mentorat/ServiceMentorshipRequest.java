...
import interfaces.mentorat.IMentorshipRequest;
...
public class ServiceMentorshipRequest implements IMentorshipRequest {
    ...
    private void createSessionForRequest(MentorshipRequest req) {
        try {
            ...
            models.mentorat.MentorshipSession session = new models.mentorat.MentorshipSession();
            ...
            session.setStatus(models.mentorat.MentorshipSession.SessionStatus.scheduled);
